...
set JVMOPTS=-Den-sent.bin.path=%OPENNLP_MODELS%/en-sent.bin -Den-token.bin.path=%OPENNLP_MODELS%/en-token.bin -Den-pos-maxent.bin.path=%OPENNLP_MODELS%/en-pos-maxent.bin -Dopennlp.en-chunker.bin.path=%OPENNLP_MODELS%/en-chunker.bin -Dlog4j.configurationFile=file://%projectdir%/config/log4j2.xml -Dmetamaplite.property.file=%CONFIGDIR%/metamaplite.properties -Dmetamaplite.entitylookup.resultlength=1500 -Dmetamaplite.ivf.cuiconceptindex=%projectdir%/data/ivf/2018AB/USAbase/strict/cuiconcept -Dmetamaplite.ivf.firstwordsofonewideindex=%projectdir%/data/ivf/2018AB/USAbase/strict/first_words_of_one_WIDE -Dmetamaplite.ivf.cuisourceinfoindex=%projectdir%/data/ivf/2018AB/USAbase/strict/cuisourceinfo -Dmetamaplite.ivf.cuisemantictypeindex=%projectdir%/data/ivf/2018AB/USAbase/strict/cuist -Dmetamaplite.ivf.varsindex=%projectdir%/data/ivf/2018AB/USAbase/strict/vars -Dmetamaplite.ivf.meshtcrelaxedindex=$PROJECTDIR/data/ivf/2018AB/USAbase/strict/indices/meshtcrelaxed
