...
import gov.nih.nlm.nls.metamap.document.*;
import gov.nih.nlm.nls.metamap.lite.*;
 ...
 * </dl>
 * The class must implement the {@link BioCDocumentLoader BioCDocumentLoader} interface.
 * <p>
 * Example property values
 * <dl>
 * <dt>bioc.document.loader.freetext</dt><dd>{@link FreeText gov.nih.nlm.nls.metamap.document.FreeText}</dd>
 * <dt>bioc.document.loader.chemdner</dt><dd>{@link ChemDNER gov.nih.nlm.nls.metamap.document.ChemDNER}</dd>
 * </dl>
 * <p>
 ...
 * {@link ResultFormatter ResultFormatter.}
 * <p>
 * Example property values:
 * <dl>
 * <dt>metamaplite.result.formatter.cuilist</dt><dd>{@link CuiList gov.nih.nlm.nls.metamap.lite.resultformats.CuiList}</dd>
 * <dt>metamaplite.result.formatter.brat</dt><dd>{@link Brat gov.nih.nlm.nls.metamap.lite.resultformats.Brat}</dd>
 * </dl>
 */
public class MetaMapLiteServer {
    ...
    private static boolean listAcronymsOption;
    private static boolean listSentencesWithPosTags;
    private static boolean listChunks;
    private static String outputExtension;
    private static String outputFormatOption;
    ...
    public static void main(String[] args)
        ...
        if (args.length > 0) {
            ...
            metaMapLiteInst = new MetaMapLiteServer(properties);
            ...
            if (inputFromStdin) {
                ...
                if (filenameList.get(0).startsWith("http")) {
